...
export function getMapStylePreviewUrl(
  styleKey: keyof typeof MAP_STYLES
): string {
  const previewUrls: Record<keyof typeof MAP_STYLES, string> = {
